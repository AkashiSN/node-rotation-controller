      ...
      themeConfig: {
        ...
        sidebar: [
          ...
          { text: 'Reference', collapsed: false, items: [
            ...
            { text: 'ADR-0002 drain estimate', link: '/reference/adr/0002-drain-estimate-vs-force-kill-deadline' },
            { text: 'ADR-0003 provisioning estimate', link: '/reference/adr/0003-provisioning-estimate-vs-surge-abandon-deadline' },
            { text: 'ADR-0004 failure pause', link: '/reference/adr/0004-failure-pause-vs-cooldown-after' },
            { text: 'ADR-0005 whole-node reservation', link: '/reference/adr/0005-whole-node-reservation-vs-capacity-absorb' },
      ...
      themeConfig: {
        ...
        sidebar: [
          ...
          { text: 'リファレンス', collapsed: false, items: [
            ...
            { text: 'ADR-0002 drain estimate（英語）', link: '/reference/adr/0002-drain-estimate-vs-force-kill-deadline' },
            { text: 'ADR-0003 provisioning estimate（英語）', link: '/reference/adr/0003-provisioning-estimate-vs-surge-abandon-deadline' },
            { text: 'ADR-0004 failure pause（英語）', link: '/reference/adr/0004-failure-pause-vs-cooldown-after' },
            { text: 'ADR-0005 whole-node 予約（英語）', link: '/reference/adr/0005-whole-node-reservation-vs-capacity-absorb' },
          ]},
        ],
      },
    },
