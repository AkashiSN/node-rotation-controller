...
// core Kubernetes types (Nodes, Pods, Leases, Events, ...) and karpenter.sh/v1
// (NodeClaim, NodePool). All client and cache construction must go through
// this single source so the type universe never diverges between binaries
// and tests.
